...
# class OldPickled(datasets.DatasetBuilder):
#     BUILDER_CONFIG_CLASS = PickledConfig
...
#     def _prepare_split(self, SplitGenerator, **kwargs):
#         # No-op, examples assumed to already be found on disk.
#         pass
...
#                 assert all(len(batch[k]) == num_rows for k in keys)
#                 for i in range(num_rows):
#                     d = { k: batch[k][i] for k in keys }
#                     print(d)
#                     yield id_, d
#                     id_ += 1
